...
final class PlantTable extends PowerGridComponent
{
    use WithExport;
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Plant name', 'plant_name')
                ->sortable()
                ->searchable(),
    ...
    #[\Livewire\Attributes\On('plantUpdate')]
    public function plantUpdate(Plant $plant): void
    {
        $this->dispatch('eventPlantUpdate', $plant);
    }

    public function actions(\App\Models\Plant $plant): array
    {
        return [
            Button::make('edit', '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                ->route('plants.update', ['plant' => $plant]),
            ...
            Button::make('destroy', '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                ->openModal('delete-plant', ['id' => $plant->id]),
        ];
    }
