...
class ImportSpecific extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:import-specific';
     ...
     * @var string
     */
    protected $description = 'Import Herbarium specific from CSV file';
