...
class ImportTaluk extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:import-taluk';
     ...
     * @var string
     */
    protected $description = 'Import Herbarium taluk from CSV file';
